    ...
    def make_move(self):
        ...
        for key in self.tic_tac_toe.board.keys():
            if self.tic_tac_toe.space_is_free(key):
                ...
                score = self.minimax(self.tic_tac_toe.board, 0, False, alpha, beta)
        ...
        if is_maximizing:
            ...
            for key in tic_tac_toe.board.keys():
                if tic_tac_toe.space_is_free(key):
                    ...
                    score = self.minimax(tic_tac_toe.board, depth + 1, False, alpha, beta)
            ...
            for key in tic_tac_toe.board.keys():
                if tic_tac_toe.space_is_free(key):
                    ...
                    score = self.minimax(tic_tac_toe.board, depth + 1, True, alpha, beta)
                    tic_tac_toe.board[key] = ' '
